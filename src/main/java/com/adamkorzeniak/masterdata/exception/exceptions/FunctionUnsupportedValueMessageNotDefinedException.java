...
/**
 * 
 * Exception is thrown when trying to handle InvalidQueryParamValueException, but error message for the function was not defined 
 *
 */
public class FunctionUnsupportedValueMessageNotDefinedException extends RuntimeException {
	...
	public FunctionUnsupportedValueMessageNotDefinedException(SearchFunctionType function) {
		super("INTERNAL SERVER ERROR: Invalid Query Param Value Handling Error. "
